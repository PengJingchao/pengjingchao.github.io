...
<img src="http://latex.codecogs.com/gif.latex?\bigtriangledown&space;f(\mathbf{x})=\mathbf{0}" title="\bigtriangledown f(\mathbf{x})=\mathbf{0}" /><br />
<img src="http://latex.codecogs.com/gif.latex?\left&space;(\bigtriangledown&space;f(\mathbf{x})&space;\right&space;)^{2}>&space;\mathbf{0}" title="\left (\bigtriangledown f(\mathbf{x}) \right )^{2}> \mathbf{0}" />
